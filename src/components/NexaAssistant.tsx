...
const DEFAULT_MESSAGE: Message = { role: 'assistant', content: 'Halo! Saya Nexa Assistant. Ada yang bisa saya bantu terkait Instalasi Jaringan, Server, Keamanan Siber, atau layanan TJKT lainnya di NexaTech Solutions?' };
